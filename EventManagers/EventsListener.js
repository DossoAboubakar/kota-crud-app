...
import { addAnnee } from "./EventManagers/annee.js";
 export function eventListener(){
    $(document).ready(function () {
      ...
      const deleteAnneeButtons = document.querySelectorAll(".btn-deleteAnnee");
      deleteAnneeButtons.forEach((button) => {
        console.log("oikjdj");
        button.addEventListener("click", function () {
          const id = this.dataset.id;
          deleteAnnee(id);
      ...
      const deleteCategorieButtons = document.querySelectorAll(
        ".btn-deleteCategorie"
      );
      deleteCategorieButtons.forEach((button) => {
        console.log("oikjdj");
        button.addEventListener("click", function () {
          const id = this.dataset.id;
          deleteCategorie(id);
      ...
      const deleteFavorisButtons = document.querySelectorAll(".btn-deleteFavoris");
      deleteFavorisButtons.forEach((button) => {
        console.log("oikjdj");
        button.addEventListener("click", function () {
          const id = this.dataset.id;
          deleteFavoris(id);
      ...
      const deleteRechercheButtons = document.querySelectorAll(".btn-deleteRecherche");
      ...
      const deleteSignalementButtons = document.querySelectorAll(".btn-deleteSignalement");
      ...
      const deleteSituationButtons = document.querySelectorAll(".btn-deleteSituation");
      ...
      const deleteTransactionButtons = document.querySelectorAll(".btn-deleteTransaction");
      ...
      const deleteTypeBienDetailButtons = document.querySelectorAll(".btn-deleteTypeBienDetail");
      ...
      document.addEventListener('click', function (e) {
        if (e.target.closest('.btn-deleteAnnee')) {
          const btn = e.target.closest('.btn-deleteAnnee');
