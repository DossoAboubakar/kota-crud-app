    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editAnnonceForm" enctype="multipart/form-data" method="post">
                    <div class="row">
                    <div class="col-6 mb-6">
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <input type="number" class="form-control" id="<?= $labelle ?>2"
                                name="<?= $labelle ?>2"
                                placeholder="<?= strtolower($labelle) ?>" />
                            <?php else: ?>
                            <input type="<?php echo $labelle === 'image' ? 'file' : 'text'; ?>" class="form-control" id="<?= $labelle ?>2"
                                name="<?= $labelle ?>2"
                                placeholder="<?= strtolower($labelle) ?>" />
                            <?php endif; ?>
                        </div>
                        <?php endfor; ?>
                        <div id="mapEdit" style="height: 300px; margin-top: 15px;"></div>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Annuler</button>
                <button type="submit" name="editAnnonce" class="btn btn-primary" id="editBtn">Modifier</button>
            </div>
        </form>
        </div>
    </div>
