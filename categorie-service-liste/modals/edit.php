    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <form id="editCategorieServiceForm" enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        <div class="col-6 mb-6">
                            ...
                            <select class="w-100 select form-control" id="id_categorie2" name="id_categorie2">
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <select class="w-100 select form-control" name="id_categorie_service2" id="id_categorie_service2">
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <input type="<?= in_array($table_fields[$i], ['Quantité', 'Prix', 'Montant']) ? 'number' : ($table_fields[$i] === 'Image' ? 'file' : 'text') ?>" class="form-control" id="<?= $labelle ?>2"
                                name="<?= $labelle ?>2"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="editCategorieServiceListe" class="btn btn-primary" id="editBtn">Modifier</button>
            </div>
        </form>
        </div>
    </div>
