    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addCommoditeForm" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <input type="file" class="form-control" id="activeimage1" name="activeimage" />
                        </div>  
                        <div class="col-6 mb-6">
                            ...
                            <select class="w-100 select" name="type" id="type1">
